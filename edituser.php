<?php 
    define("TITLE", "Edit User | CCIT WFH Attendance Monitoring System");
    ...
    if (isset($_POST['submit'])) {
        if($_POST['password'] == $_POST['repassword']){
            $response = editUser($_POST,$_SESSION['edit_id']);
        } else{
        ...
        <section id="content" class="content">
            <div class="content__header content__boxed">
                <div class="content__wrap">
                    ...
                    <h1 class="page-title mb-0 mt-2">EDIT USER</h1>
            ...
            <div class="content__boxed">
                <div class="content__wrap">
                    <div class="card text-center mb-4 col-xl-8 offset-xl-2">
                        ...
                        <!-- SEARCH DATA -->
                        <form action="edituser.php" method="post" id="searchform">
                        ...
                        <!-- END OF SEARCH DATA -->
                        <br><hr>
                        <form action="edituser.php" class="mt-4 needs-validation" method="POST">
                            <div class="w-md-400px d-inline-flex row g-3 mb-4">
                                <div class="col-md-6 mt-3 position-relative">
                                    ...
                                    <input name="firstname" id="_dm-vCustomFirsname" type="text" class="form-control" required="" value=<?php echo $firstname;?> >
                                ...
                                <div class="col-md-6 mt-3 position-relative">
                                    ...
                                    <input name="lastname"  id="_dm-vCustomLastname" type="text" class="form-control" required="" value=<?php echo $lastname;?> >
                                    <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="col-md-12 mt-3 position-relative">
                                    ...
                                    <input name="username" id="_dm-vCustomUsername" type="text" class="form-control" required="" value=<?php echo $username;?>>
                                    <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="col-md-12 mt-3 position-relative">
                                    ...
                                    <input name="email" id="_dm-vCustomEmail" type="text" class="form-control" required="" value=<?php echo $email;?>>
                                    <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="col-md-12 mt-3 position-relative">
                                    ...
                                    <input name="secondary_email" id="_dm-vCustomEmail" type="text" class="form-control" required="" value=<?php echo $secondary_email;?>>
                                    <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="col-md-6 mt-3 position-relative">
                                    ...
                                    <input name="password" id="_dm-vCustomPassword" type="password" class="form-control" required="" value=<?php echo $password;?>>
                                    <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="col-md-6 mt-3 position-relative">
                                    ...
                                    <input name="repassword"  id="_dm-vCustomConfirmPassword" type="password" class="form-control" required="" value=<?php echo $password;?>>
                                    <div class="valid-feedback">Looks good!</div>
                                ...
                                <select name="department_id" id="_dm-vCustomDepartment" class="form-select" required="" selected=<?php echo $department_id;?>>
                            ...
                            <div class="col-md-12 mt-3 position-relative">
                                ...
                                <select name="designation_id" id="_dm-vCustomDesignation" class="form-select" required="" selected=<?php echo $designation_id;?>>
                            ...
                            <div class="col-md-6 mt-3 position-relative">
                                ...
                                <select name="role" id="_dm-vCustomAccountRole" class="form-select" required="" selected=<?php echo $user_type;?>>
                            ...
                            <div class="col-md-6 mt-3 position-relative">
                                ...
                                <select name="status" id="_dm-vCustomAccountStatus" class="form-select" required="" selected=<?php echo $active;?>>
                                ...
                                <div class="col-12 pt-4 d-grid gap-2">
                                    <button class="btn btn-primary btn-lg" type="submit" name="submit">Update User</button>                                      
                                </div>
